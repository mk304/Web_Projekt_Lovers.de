...
<div class="wrapper">
    ...
    <div id="content">
        ...
        <form id="beitragbox" style="width:200px;height:80px;display:none;>
            <div class="form-group">
        <label for="comment">Neuer Beitrag:</label>
        <textarea class="form-control" rows="5" id="comment"></textarea>
        <button class="post-btn">Posten</button>
        <button class="abort-btn">Abbrechen</button>
    </div>
    </form>
