                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <form id="register-form" class="dynamic-content"
                                              action="../register/register.php"
                                        ...
                                        <form class="dynamic-content" style="display: none" id="register-form-2" action="#">
                                            <div class="form-group">
                                                <div class="col-sm-6 col-sm-offset-3">
                                                    <input type="submit" name="weiter-submit" href="Startseite.php?seite=register-form-seite3"
                                                           tabindex="4" class="form-control btn btn-login"
                                                           value="Weiter"
                                                           onclick="sessionStorage.setItem('kuerzel');">
                                                </div>
                                        ...
                                        <form class="dynamic-content" style="display: none" id="register-form-seite3"
                                              action="#"
