...
<div class="grid-box">
    ...
    <?php } // Wenn bei der ersten Registrierungsseite das Formular ausgefüllt wurde und auf "weiter" geklickt wurde, soll die zweite Formularseite mit den Checkboxen der Skills angezeigt werden.
